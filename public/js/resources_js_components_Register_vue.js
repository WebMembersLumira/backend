...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    registerUser: function registerUser() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("http://localhost:8000/api/auth/register", formData).then(function (response) {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "form-control form-control-user mb-2",
    attrs: {
      type: "text",
      id: "name",
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.metodePembayaran,
      expression: "metodePembayaran"
    }],
    ...
    on: {
      change: function change($event) {
        ...
        _vm.metodePembayaran = $event.target.multiple ? $$selectedVal : $$selectedVal[0];
      }
    }
  }, [_c("option", {
    attrs: {
  ...
  }, [_vm._v("Pilih Metode Pembayaran")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "mandiri"
    }
  }, [_vm._v("Mandiri")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "bri"
    }
  }, [_vm._v("BRI")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "bni"
    }
  }, [_vm._v("BNI")])])]), _vm._v(" "), _c("button", {
